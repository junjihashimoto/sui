{
  ...
  inputs = {
    ...
    #nixpkgs.url = "git+file:///home/junji-hashimoto/git/nixpkgs?rev=dda5ad6feb59b4208cc5c4d70426378b882d5110";
    ...
    utils.lib.eachDefaultSystem (system:
      let
        ...
        sui = with pkgs; rustPlatform.buildRustPackage rec {
          ...
          cargoHash = "sha256-7RKB4s4qUajfS1r/dnfEhDGBSEW9n7RHLEp6d/wZyB8=";
